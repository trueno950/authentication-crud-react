...
import { Button, Input, Label, RouterBack } from '@/components'
...
export const ForgotPassword = () => {
  ...
  const onElementChanged = ({ target }: React.ChangeEvent<HTMLInputElement>) => {
      ...
      .then(() => {
        dispatch(
          thunkShowToast({
            show: true,
            type: 'success',
            description: 'Se le enviaron las instrucciones en su email para restaurar su contraseña'
          })
        )
        navigate('/login')
      })
      ...
      <div className="forgot-content">
        <div className="forgot-content-card">
          ...
          <p className="text-center label-small">
            Se le enviará un email a la dirección de correo proporcionada con los pasos a seguir para la recuperación su
            contraseña.
          </p>
          <form className="forgot-form" onSubmit={formSubmit}>
            <div className="form-group">
              ...
              />
              {validateEmail.email && <span className="form-error-message">{validateEmail.message}</span>}
            </div>
